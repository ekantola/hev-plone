...
class IEventCollectionPortlet(IPortletDataProvider):
...
class Assignment(base.Assignment):
    ...
    implements(IEventCollectionPortlet)
...
class Renderer(base.Renderer):
    ...
    _template = ViewPageTemplateFile('eventCollection.pt')
...
class AddForm(base.AddForm):
    ...
    """
    form_fields = form.Fields(IEventCollectionPortlet)
