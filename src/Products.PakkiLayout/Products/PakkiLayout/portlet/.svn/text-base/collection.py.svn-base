...
class IImageCollectionPortlet(IPortletDataProvider):
...
class Assignment(base.Assignment):
    ...
    implements(IImageCollectionPortlet)
...
class Renderer(base.Renderer):
    ...
    _template = ViewPageTemplateFile('imageCollection.pt')
...
class AddForm(base.AddForm):
    ...
    """
    form_fields = form.Fields(IImageCollectionPortlet)
