...
class IViikonKuvaPortlet(IPortletDataProvider):
...
class Renderer(base.Renderer):
    ...
    _template = ViewPageTemplateFile('viikonKuva.pt')
...
class AddForm(base.AddForm):
    ...
    """
    form_fields = form.Fields(IViikonKuvaPortlet)
