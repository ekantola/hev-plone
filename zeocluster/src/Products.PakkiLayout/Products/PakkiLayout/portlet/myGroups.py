...
class Renderer(base.Renderer):
    ...
    _template = ViewPageTemplateFile(u'myGroups.pt')
    ...
    def mygroups(self):
        ...
        groups = self.context.portal_groups.getGroupsByUserId(member.getId())
        return groups
...
class AddForm(base.AddForm):
    ...
    description = _(u"This portlet display listing of groups that the current user belongs to.")
